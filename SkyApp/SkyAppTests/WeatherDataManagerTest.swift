...
class WeatherDataManagerTest: XCTestCase {
    ...
    func test_weatherDataAt_hanle_response_decode() {
        ...
        let expect = WeatherData(latitude: 52, longitude: 100, currently: WeatherData.CurrentWeather(time: Date(timeIntervalSince1970: 1507180335), summary: "Light Snow", icon: "snow", temperature: 23, humidity: 0.91))
